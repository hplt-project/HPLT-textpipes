...
# If you need staging files from LUMIO and sequentially processing several html.zst in one SLURM job to save waiting time in the LUMI queue,
# refer to stage2nodeparallel_batched.sh
NJOBS=$1
FPATHS=$2
